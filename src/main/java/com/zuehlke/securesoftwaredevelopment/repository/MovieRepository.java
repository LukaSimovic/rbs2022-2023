...
public class MovieRepository {
    ...
    public List<Movie> getAll() {
        ...
        try (Connection connection = dataSource.getConnection();
            ...
            LOG.warn("Failed to retrieve movies, e");
        }
        return movieList;
    }
    ...
    public List<Movie> search(String searchTerm) throws SQLException {
        ...
        try (Connection connection = dataSource.getConnection();
            ...
            LOG.warn("Failed to retrieve movie or movies for search term " + searchTerm, e);
        }
        return movieList;
    }
            ...
            if (generatedKeys.next()) {
                ...
                genresToInsert.stream().forEach(genre -> {
                    ...
                    try (PreparedStatement statement2 = connection.prepareStatement(query2);
                        ...
                        AuditLogger
                                .getAuditLogger(MovieRepository.class)
                                .audit("The movie " + movie.getTitle() + " is successfully created");
                    } catch (SQLException e) {
                        LOG.warn("Failed to add new movies to genres relation", e);
                    }
                });
            }
        } catch (SQLException e) {
            LOG.warn("Failed to create a movie " + movie.getTitle(), e);
        }
        return id;
    }
    ...
    public void delete(int movieId) {
        ...
        try (Connection connection = dataSource.getConnection();
            ...
            AuditLogger
                    .getAuditLogger(MovieRepository.class)
                    .audit("The movie " + movieId + " is successfully deleted");
        } catch (SQLException e) {
